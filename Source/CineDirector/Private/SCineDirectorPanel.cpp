...
TSharedRef<SWidget> SCineDirectorPanel::BuildShotBuilder()
{
	...
	const TArray<FPreset> Presets =
	{
		...
		{ LOCTEXT("PresetFollow", "Follow & look-at"),
		  TEXT("Orbit around the [actor] looking at the [other actor], 50mm. Then follow the [other actor], close-up, shallow focus") },
		{ LOCTEXT("PresetRefocus", "Cut & refocus"),
		  TEXT("Medium shot of the [actor], shallow focus. Then push in on the [other actor], refocus on the [other actor], 85mm") },
		...
		{ LOCTEXT("PresetHorror", "Horror style"),
		  TEXT("Slight close-up of the [actor], horror style, shallow focus. Then push in on the [actor], slight dutch") },
		{ LOCTEXT("PresetNolan", "Nolan / IMAX"),
		  TEXT("Wide shot of the [actor], Nolan style, deep focus. Then slow half orbit around the [actor], cinematic") },
		{ LOCTEXT("PresetBodycam", "Bodycam"),
		  TEXT("Follow the [actor], bodycam style, slight close-up") },
		{ LOCTEXT("PresetAction", "Action style"),
		  TEXT("Push in on the [actor], action style, handheld. Then truck right past the [actor], 28mm") },
	};
	...
	const TArray<FChipGroup> Groups =
	{
		...
		{ LOCTEXT("ChipsFraming", "Framing"),
			{ TEXT("extreme close-up"), TEXT("slight close-up"), TEXT("close-up"), TEXT("medium close-up"),
			  TEXT("medium shot"), TEXT("wide shot"), TEXT("establishing shot") } },
		{ LOCTEXT("ChipsAngle", "Angle, side & aim"),
			{ TEXT("low angle"), TEXT("high angle"), TEXT("overhead"), TEXT("from behind"), TEXT("from the left"),
			  ...
			  TEXT("over the shoulder"), TEXT("looking at"), TEXT("gaze at"), TEXT("follow"), TEXT("track"),
			  TEXT("lock on"), TEXT("stay on") } },
		{ LOCTEXT("ChipsLens", "Lens & focus"),
			{ TEXT("24mm"), TEXT("50mm"), TEXT("85mm"), TEXT("telephoto"), TEXT("f/1.8"), TEXT("shallow focus"),
			  TEXT("deep focus"), TEXT("autofocus"), TEXT("focus on"), TEXT("refocus on"),
			  TEXT("rack focus from X to Y"), TEXT("fixed focus") } },
		{ LOCTEXT("ChipsStyle", "Style kits"),
			{ TEXT("cinematic"), TEXT("action"), TEXT("horror"), TEXT("thriller"), TEXT("noir"),
			  TEXT("Nolan style"), TEXT("bodycam"), TEXT("cctv"), TEXT("found footage"), TEXT("CRT"), TEXT("VHS"),
			  TEXT("cyberpunk"), TEXT("romance"), TEXT("documentary"), TEXT("music video"), TEXT("western"), TEXT("indie") } },
		{ LOCTEXT("ChipsEffects", "Effects"),
			{ TEXT("slightly handheld"), TEXT("handheld"), TEXT("very shaky"), TEXT("slight dutch"), TEXT("dutch angle"),
			  TEXT("slight film grain"), TEXT("film grain"), TEXT("vignette"), TEXT("chromatic aberration"),
			  TEXT("bloom"), TEXT("lens flares") } },
